...
val goldAugments = mapOf(
    ...
    "격전의 지하도시" to Pair ("암시장에서 시머를 사용하지 않기로 결정할 때마다 플레이어 체력을 4 회복하고 6골드를 획득합니다. 레니를 획득합니다.",listOf("특성 전용","체력","돈","챔피언")),
    ...
    "쓰레기 청소부" to Pair ("전투마다 적 챔피언 4명이 처음 처치되면 아군 챔피언 1명에게 임시 완성 아이템 1개를 제공합니다.",listOf("전투")),
