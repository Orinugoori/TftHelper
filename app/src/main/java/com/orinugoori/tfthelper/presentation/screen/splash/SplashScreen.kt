package com.orinugoori.tfthelper.presentation.screen.splash
...
fun SplashScreen(onSplashFinished: () -> Unit) {
    ...
    Column(
        ...
        AsyncImage(model = "android.resource://com.orinugoori.tfthelper/drawable/tft_helper_text_logo", contentDescription = null, modifier = Modifier.size(200.dp) )
...
fun GifLoader() {
    ...
    val painter = rememberAsyncImagePainter(
        model = ImageRequest.Builder(context)
            .data("android.resource://com.orinugoori.tfthelper/raw/rotate_spatula") // GIF 경로
            .build(),
